  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.userInfoSection}>
        <View style={{marginTop: -30, backgroundColor:"#F6ECDC", alignItems:'center'}}>
          <Avatar.Image
            source={require('../../assets/images/longhorn.jpg')}
            size={125}
          />
          <View style={{marginLeft:20,backgroundColor:"#F6ECDC"}}>
            <Title style={[styles.title, {marginTop:10, marginBottom:5,}]}>Bevo</Title>
      ...
      <View style = {[styles.row, {backgroundColor: "#f6ecdc"}]}>
        <Text style={{color:"#000", marginLeft:30, fontSize: 16, marginTop: -35}}>Food →</Text>
      </View>
      ...
      <View style = {[styles.row, {backgroundColor: "#f6ecdc"}]}>
        <Text style={{color:"#000", marginLeft:30, fontSize: 16, marginTop: 15}}>Landmarks →</Text>
      </View>
      <View style={{flexDirection:'row', marginLeft: 30, backgroundColor: "#f6ecdc"}}>
      ...
      <View style = {[styles.row, {backgroundColor: "#f6ecdc"}]}>
        <Text style={{color:"#000", marginLeft:30, fontSize: 16, marginTop: 15}}>Events →</Text>
      </View>
      <View style={{flexDirection:'row', marginLeft: 30, backgroundColor: "#f6ecdc"}}>
